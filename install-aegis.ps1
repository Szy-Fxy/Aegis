<#
.SYNOPSIS
    Aegis v3.0.7 — 跨 IDE AI 编程助手开发治理系统安装脚本
.DESCRIPTION
...
Write-Host "🛡️  Aegis v3.0.7 — 安装中..." -ForegroundColor Cyan
...
> 本项目使用 [Aegis v3.0.7](docs/Aegis_Intro.md) AI 开发治理系统。
...
$cursorContent = @"
---
description: Aegis v3.0.7 — AI 开发治理系统。行为准则 + 工程规范 + 工作流规则。始终生效。
alwaysApply: true
---

# Aegis v3.0.7 — AI 开发治理系统
...
Write-Host ""
Write-Host "🛡️  Aegis v3.0.7 安装完成！" -ForegroundColor Green

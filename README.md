...
把 `Aegis/` 文件夹复制到新项目根目录。安装脚本会自动生成 `AGENTS.md`（跨平台 AI 通用入口）。手动复制时，在根目录创建 `AGENTS.md`，内容最少写一句：
...
| 环境 | 支持方式 |
|------|----------|
| Claude Code | `AGENTS.md` / `CLAUDE.md` 入口文件 |
...
Aegis/
 ...
 skills/
    ...
    aegis-boot/                    启动技能（HanaAgent/Trae 等平台）
        SKILL.md

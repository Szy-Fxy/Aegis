...
> ⚠️ v5.x 是基于 CLI 的新架构。旧版纯 markdown 文档方案（v3.x）已弃用，不再维护。
> 如需旧版请切至 [v3.1.0](https://github.com/Szy-Fxy/Aegis/tree/v3.1.0)。

AI 开发治理工具链。从需求登记到验收，全流程状态可追踪、阶段有检查、断点可恢复。

> 由于当前版本在第一阶段并不能真正解决AI开发时的问题。为了解决AI开发时忘记了使用Aegis开发，每次提新需求前请加一个'Aegis'。别手写 INDEX.md，登记、推进、记录由 CLI 管理。
...
| Phase | 内容 | 状态 |
|-------|------|------|
| 1 | CLI + state.json + classifier + 测试覆盖 | ✅ v5.2.2 |

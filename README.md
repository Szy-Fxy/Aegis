...
把 `Aegis/` 文件夹复制到新项目根目录。安装脚本会自动生成含完整行为准则的 `Aegis_Protocol.md`。手动复制时，在根目录创建 `Aegis_Protocol.md`，推荐复制 `Aegis/docs/Aegis_Protocol.md` 中的行为准则内容，或最少写一句：
...
| 环境 | 支持方式 |
|------|----------|
| Claude Code | `Aegis_Protocol.md` 入口文件 |
...
```
Aegis/
 README.md                         本文件（AI 入口 + GitHub 展示页）
 install.ps1                       一键安装脚本

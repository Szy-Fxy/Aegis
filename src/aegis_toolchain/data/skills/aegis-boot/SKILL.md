---
name: "aegis-boot"
description: "Aegis AI Development Governance System Boot Loader v5.2.2. MANDATORY activation on any code-related task. Activates on: develop, create, modify, refactor, fix, implement, code, configure, requirement, feature, bug, optimize, test, deploy, build, design, review, debug, write, add, remove, update, change, improve."
---

# Aegis Boot v5.2.2

> This project uses **Aegis v5.2.2** — AI Development Governance Toolchain.

...
把 `Aegis/` 文件夹复制到新项目根目录。安装脚本会自动生成含完整行为准则的 `Aegis_Protocol.md`。手动复制时，在根目录创建 `Aegis_Protocol.md`，推荐复制 `Aegis/README.md` 中的行为准则内容，或最少写一句：
...
v3.0.3  完整介绍见 [Aegis.md](Aegis_Intro.md)
